	...
	<div class="container">
		<div class="write-form">
			...
			<form>
				...
				<div class="form-group">
		         	내용:<textarea class="form-area" id="content" name="content"  placeholder="<%=dto.getContent() %>" readonly="readonly"></textarea>
		        </div> 
	...
	<div class="answer-from">
		<form id="frm">
			...
			<!-- max(step) 번호로 댓글 갯수 확인 -->
				<h6>총 <%=dto.getStep() %>개의 답글이 있습니다</h6>
			
				<textarea class="answer-area"></textarea>
				<div class="form-group">
		            <button type="button" class="btn1" id="btn2">답글 작성</button>
		        </div>
...
<tr><td colspan="4" ><textarea class="form-area"></textarea></td><td></td><td style="float: right" id="btn2"><button type="button" >답글작성</button></td></tr>
</table>
</div>
<br><br>
<!-- max(step) 번호로 체크후 댓글 유무 확인-->
