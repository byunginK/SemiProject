<<<<<<< HEAD:WebContent/main/MemDeleteAf.jsp
...
<!-- 바디 셋팅 -->
  <div class="main_body_content">
      ...
      <!-- 헤더 끝 -->
<h1>저희 심플파이브를 이용해주셔서 감사합니다</h1>
<h1>더욱더 좋은 상품으로 발전하고 노력하는 심플파이브가 되겠습니다</h1>
<br><br>
<button type="button" onclick="location.href='./FirstOpen.jsp'">메인화면으로</button>
...
>>>>>>> f982e6c7156f923d7a831a301fdbc28d99c1bedb:WebContent/myPage.jsp
</html>