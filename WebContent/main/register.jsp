<<<<<<< HEAD:WebContent/main/register.jsp
        	...
        	<div class="regi-form2">
					...
					<input type="hidden" name="work" value="addMem">
					   ...
					   <!-- 아이디  -->
						...
						<div class="form-group">
							<input type="text" class="form-control" name="pwd" placeholder="비밀번호 확인" maxlength="25" id="pwdCheck">
						</div>
						<!-- 이름 -->
						<div class="form-group">
						</div>	
...
>>>>>>> f982e6c7156f923d7a831a301fdbc28d99c1bedb:WebContent/register.jsp
</html>