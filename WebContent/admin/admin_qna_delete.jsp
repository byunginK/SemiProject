...
<table id="tblist">
<col width="50"><col width="150"><col width="500"><col width="150">
<tr id="thtitle">
...
<%
	...
	<tr class='listtr'>
		<td style="text-align:center;"><input type="checkbox" name="delchk" class="itext" value='<%=dto.getSeq() %>' ></td>
		<td><%=dto.getId() %></td>
		<td><%=dto.getTitle() %></td>
		<td><%=dto.getUdate() %></td>
	</tr>
...
<% }
   if(endBlock > tpage){
	...
	if(pageNumber == i){
%>
	<li><span style="font-weight:bold; color:#9d6b53 font-size:18pt;"><%=i+1 %></span></li>
	<%}else{ %>
