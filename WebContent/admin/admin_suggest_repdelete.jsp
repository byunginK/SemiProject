...
<%
	...
	<tr class='listtr'>
		<td><input type="checkbox" name="delchk" class="itext" value='<%=dto.getAnswer_Seq() %>' ></td>
...
$("#schbtn").click(function() {
	...
	location.href="./admincont?work=sugrep_qsearch&need="+need+"&fneed="+fneed+"&pageNumber=0";
...
function goPage(data) {
	...
	if('<%=need%>'==""){
		...
		location.href="./admincont?work=sugrep_qsearch&need=<%=need%>&fneed=<%=fneed%>&pageNumber="+data;
	}
