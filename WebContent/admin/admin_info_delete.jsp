...
<% if(list.size()==0 || list == null){%>
	<tr class='listtr'><td colspan="2">작성된 글이 없습니다</td></tr>
<%
	}else{
	...
	<tr class='listtr'>
		<td><input type="checkbox" class="itext" name="delchk" value='<%=dto.getSeq() %>' ></td>
	...
	<tr class='listtr' style='display:none;' id=<%=dto.getSeq() %>>
		...
		<td><input type="text" style="border:none; width:500px; font-size:9pt; word-break:break-all;" value="<%=dto.getContent() %>"> </td>
