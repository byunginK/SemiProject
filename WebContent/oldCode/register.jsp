        ...
        <!-- 석호씨 적용부분 시작  나머진 맨 아래있슴당-->
		       <div align="center">
				...
				<div align="center">
					<form id="frm">
						<table>
							<tr><td align="center">회원가입</td></tr>
							<tr><td><input type="text" name="id" placeholder="아이디" maxlength="20" id="id"></td><td><button type="button" id="btn">중복체크</button></td></tr>
							<tr><td><input type="text" name="pwd" placeholder="비밀번호" maxlength="25" id="pwd"></td></tr>
							<tr><td><input type="text" name="name" placeholder="이름" id="name"></td></tr>
							<tr><td><input type="text" name="phone" placeholder="휴대폰번호" maxlength="11" id="number"></td></tr>
							<tr><td><input type="text" name="email" placeholder="이메일" id="email"></td></tr>
							<tr><td align="center"><button type="button" id="regi">회원가입</button></td></tr>
						</table>
					</form>
				</div>
