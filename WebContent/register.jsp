				...
				<div>
					<form action="register2.jsp" method="POST">
						...
						<section id="fregister_term">
							...
							<!-- 약관 -->
							<textarea class="area" readonly>
제1장 총칙
제1조(목적)
본 약관은 ((주)심플파이브) 홈페이지가 제공하는 모든 서비스의 이용조건 및 절차, 이용자와 (주)심플파이브의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (약관의 효력과 변경)
(주)심플파이브는 귀하가 본 약관 내용에 동의하는 경우, (주)심플파이브의 서비스 제공 행위 및 귀하의 서비스 사용 행위에 본 약관이 우선적으로 적용됩니다. (주)심플파이브는 본 약관을 사전 고지 없이 변경할 수 있으며, 변경된 약관은 (주)심플파이브 홈페이지 내에 공지하고, 공지와 동시에 그 효력이 발생됩니다. 회원이 변경된 약관에 동의하지 않는 경우, 본인의 회원등록을 취소(회원탈퇴)할 수 있으며 계속 사용의 경우는 약관 변경에 대한 동의로 간주됩니다. 본 약관에 명시되지 않은 사항은 전기통신기본법, 전기통신사업법, 정보통신윤리위원회 심의규정, 정보통신 윤리강령, 프로그램보호법 및 기타 관련 법령의 규정에 의합니다.

제 3 조 (용어의 정의)
본 약관에서 사용하는 용어의 정의는 다음과 같습니다.

- 이용자 : 본 약관에 따라 (주)심플파이브가 제공하는 서비스를 받는 자.
...
제2장 서비스 제공 및 이용
제 4 조 (이용계약의 성립 및 탈퇴)
이용계약은 신청자가 온라인으로 (주)심플파이브에서 제공하는 소정의 가입신청 양식에서 요구하는 사항을 기록하여 가입을 완료하는 것으로 성립됩니다. (주)심플파이브는 다음 각 호에 해당하는 이용계약에 대하여는 가입을 취소할 수 있습니다.
...
⑤ 기타 (주)심플파이브가 정한 이용신청요건이 미비 되었을 때
제 5 조 (회원정보 사용에 대한 동의)
회원의 개인정보는 공공기관의 개인정보보호에 관한 법률에 의해 보호됩니다. (주)심플파이브의 회원 정보는 다음과 같이 사용, 관리, 보호됩니다.

①개인정보의 사용 : (주)심플파이브는 서비스 제공과 관련해서 수집된 회원의 신상정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 정보통신윤리위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우, 귀하가 (주)심플파이브에 제공한 개인정보를 스스로 공개한 경우에는 그러하지 않습니다.
②개인정보의 관리 : 귀하는 개인정보의 보호 및 관리를 위하여 서비스의 개인정보관리에서 수시로 귀하의 개인정보를 수정/삭제할 수 있습니다.
③개인정보의 보호 : 귀하의 개인정보는 오직 귀하만이 열람/수정/삭제 할 수 있으며, 이는 전적으로 귀하의 ID와 비밀번호에 의해 관리되고 있습니다. 따라서 타인에게 본인의 ID와 비밀번호를 알려주어서는 안 되며, 작업 종료 시에는 반드시 로그아웃 해주시기 바랍니다. 회원이 본 약관에 따라 이용신청을 하는 것은, (주)심플파이브가 신청서에 기재된 회원정보를 수집, 이용하는 것에 동의하는 것으로 간주됩니다.
제 6 조 (사용자의 정보 보안)
가입 신청자가 (주)심플파이브 서비스 가입 절차를 완료하는 순간부터 귀하는 입력한 정보의 비밀을 유지할 책임이 있으며, 회원의 ID와 비밀번호를 사용하여 발생하는 모든 결과에 대한 책임은 회원 본인에게 있습니다. ID와 비밀번호에 관한 모든 관리의 책임은 회원에게 있으며, 회원의 ID나 비밀번호가 부정하게 사용되었다는 사실을 발견한 경우에는 즉시 (주)심플파이브에 신고하여야 합니다. 신고를 하지 않음으로 인한 모든 책임은 회원 본인에게 있습니다. 이용자는 (주)심플파이브 서비스의 사용 종료 시마다 정확히 접속을 종료해야 하며, 정확히 종료하지 아니함으로써 제3자가 귀하에 관한 정보를 이용하게 되는 등의 결과로 인해 발생하는 손해 및 손실에 대하여 (주)심플파이브는 책임을 부담하지 아니합니다.
...
제 13 조 (손해배상)
(주)심플파이브는 무료로 제공되는 서비스와 관련하여 회원에게 어떠한 손해가 발생하더라도 (주)심플파이브가 고의로 행한 범죄행위를 제외하고 이에 대하여 책임을 부담하지 아니합니다.
...
(주)심플파이브는 회원이나 제3자에 의해 표출된 의견을 승인하거나 반대하거나 수정하지 않습니다. (주)심플파이브는 어떠한 경우라도 회원이 서비스에 담긴 정보에 의존해 얻은 이득이나 입은 손해에 대해 책임이 없습니다. 
...
<!-- 개인정보 처리방침 안내 -->
						<section id="fregister_private">
							...
							<div>
								<!-- 처리방침 -->
								<textarea class="area" readonly>
'(주)심플파이브'(이하 '회사')는 고객님의 개인정보를 중요시하며, &#034;정보통신망 이용촉진 및 정보보호&#034;에 관한 법률을 준수하고 있습니다. 
