...
public class ProductDetailDao {
	...
	public boolean existCart(String id, int item_seq, String color, String item_size) {
		String sql = " SELECT 1 FROM FIVE_CART WHERE ID = ? AND ITEM_SEQ =? AND COLOR = ? AND ITEM_SIZE = ?  ";
		...
		try {
			...
			psmt.setString(4, item_size);
			System.out.println("1/6 existcart success");
			
			rs = psmt.executeQuery();
			System.out.println("2/6 existcart success");
			
			if(rs.next()) count = rs.getInt(1);
			System.out.println("3/6 existcart success");
