      ...
      <div class="container_padding" align="center">
		...
		<hr>
			...
			<div class="deltbcontainer">
				<table id="tblist">
				<col width="120px"> <col width="500px"><col width="250px">
					<tr class="thtitle">
					...
					<tr class='listtr'>
						...
						<td><input type="text" value="<%=dto.getTitle() %>" style="border:none; width: 100%" onclick="showCont(<%=dto.getSeq()%>)"></td>
						<td><%=dto.getWdate() %></td>
					</tr>
					<tr class='listtr' style='display:none;' id=<%=dto.getSeq() %>>
						<td><input type="text" style="border:none;" value="▶ 내용 : " size="5"></td>
						<td colspan="2"><input type="text" style="border:none; width:100%; font-size:9pt; word-break:break-all;" value="<%=dto.getContent() %>"> </td>
