...
//회원등급
function GradeView() {
	window.open('main/GradeView.html', 'newWindow', 'width=500, height=770, left=650, top=70');
}
//댓글창
function NewView() {
	window.open('main/AnswerList.jsp?id=<%=id%>', 'newWindow', 'width=500, height=500, left=420, top=100');
}
</script>
